...
const Vantagens = () => {
  return (
    <section id="vantagens" className=" py-16 px-6">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="text-left">
          <p className="text-sm font-bold text-[var(--color-secondary)] uppercase mb-2">
            Vantagens
          </p>
          ...
          <h2 className="flex flex-wrap items-baseline gap-2 font-extrabold leading-tight text-black">
            ...
            <span className="italic text-[var(--color-primary)] text-6xl md:text-7xl">
              burocracia
            </span>
          </h2>
          ...
          <div className="space-y-6 max-w-md text-black">
            {[
              ...
              <div key={idx} className="flex items-start gap-3">
                <BsCheck2Circle
                  className="text-[var(--color-primary)] mt-1 w-8 h-8"
                  aria-hidden="true"
                />
                <div>
        ...
        <div className="relative w-full h-[360px] md:h-[420px] flex items-center justify-center">
          <div className="absolute top-0 right-0 w-[500px] h-[280px] md:w-[340px] md:h-[220px] rounded-xl overflow-hidden shadow-lg z-0">
            <div className="relative w-full h-full rounded-xl overflow-hidden">
              <Image
                src="/painel-solar.jpg"
                alt="Painéis solares"
                fill
